...
User.hasMany(TenantApplication, {
...
Unit.hasMany(Payment, { foreignKey: "unitId", as: "payments" }); // NEW ASSOCIATION
Unit.hasMany(Invoice, { foreignKey: "unitId", as: "invoices" }); // NEW ASSOCIATION

// Tenant Application associations
TenantApplication.belongsTo(Unit, { foreignKey: "unitId", as: "unit" });
TenantApplication.belongsTo(User, {
  foreignKey: "applicantId",
  as: "applicant",
});
...
Lease.belongsTo(TenantApplication, {
...
Invoice.belongsTo(Unit, { foreignKey: "unitId", as: "unit" }); // NEW ASSOCIATION
Invoice.hasMany(Payment, { foreignKey: "invoiceId", as: "payments" });

// Payment associations
Payment.belongsTo(Invoice, { foreignKey: "invoiceId", as: "invoice" });
Payment.belongsTo(User, { foreignKey: "tenantId", as: "tenant" });
Payment.belongsTo(Unit, { foreignKey: "unitId", as: "unit" }); // NEW ASSOCIATION
